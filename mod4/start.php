...
if (!isset($_POST['submitted']) || !empty($errors)) {
    ...
    <form action="start.php" method="post">
        ...
        <div class="fieldSet">
            <fieldset>
                <p><label class="field" for="user_name"><span>*</span>User Name:</label><input type="text" name="user_name" size="15" maxlength="20" value="<?php echo (isset($_POST['username']) ? $_POST['username'] : ''); ?>"/> </p>
                <p><label class="field" for="pass1"><span>*</span>Password:</label><input type="password" name="pass1" size="10" maxlength="20" /></p>
                <p><label class="field" for="pass2"><span>*</span>Confirm Password:</label><input type="password" name="pass2" size="10" maxlength="20" /></p>
                <p><input id="submit_button" type="submit" name="submit" value="Register" /></p>
