...
if (empty($errors)) { // If everything's OK.
    ...
    if (isset($_POST['submitted'])) {
        ...
        $ro = '';
        $submitButton = '<p><input id="submit_button" type="submit" name="submit" value="Submit" /></p>';
    }
    if ($myform == "current.php") {
        echo '<fieldset>';
        echo '<p><label class="field" for="username">User Name:</label><input name="username" type="text" size="10" maxlength="20" disabled="disabled" value="' . $name . '" ></input></p>' . "\n";
        echo '</fieldset>';
    }
